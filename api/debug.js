...
export async function GET(req) {
  ...
  const providers = [
    { name: 'gemini', key: process.env.GEMINI_API_KEY, testUrl: 'https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=', model: 'gemini-3.1-pro-preview' },
